  ...
  let locals = {
    FAQ: {
      "General Questions": {
        ...
        "What is the expiration period of a trade?": "The <b>expiration period</b> is the time after which a trade automatically closes. With Tradexly, you can set it from <b>1 minute to 1 month</b>, depending on your trading style.",
        ...
        "Do I need trading experience to start?": "No. Tradexly offers a <b>demo account</b> where you can practice with virtual funds. This allows you to test strategies and understand the platform before risking real money.",
        "Can I trade on mobile devices?": "Yes. Tradexly is fully <b>web-based</b> and optimized for smartphones and tablets. You can also install our official <b>mobile app</b> for iOS and Android.",
        ...
        "What assets can I trade on Tradexly?": "Tradexly offers <b>multiple asset classes</b>: currency pairs, company stocks, indices, commodities like oil & gold, and even popular cryptocurrencies like Bitcoin and Ethereum.",
        "Can I close my account? How?": "Yes. You can close your Tradexly account anytime by going to <b>Profile Settings</b> and selecting <b>Delete Account</b>. Your funds must be withdrawn before closure."
      },
      "Financial Questions": {
        ...
        "How long does it take to withdraw funds?": "Withdrawals are processed within <b>1–5 business days</b>, depending on the payment provider. Many withdrawals are completed on the <b>same day</b>.",
        "Are there fees for deposits or withdrawals?": "Tradexly charges <b>no internal fees</b>. However, your bank or payment provider may apply their own <b>transaction or conversion fees</b>.",
      ...
      "Account and Verification": {
        ...
        "What is account verification?": "Verification confirms your <b>identity</b> and <b>residence</b>. Tradexly may request a passport or ID copy, a selfie, or proof of address for security purposes.",
        ...
        "Can I have more than one account?": "Each user can have one verified account. However, inside Tradexly you get <b>two balances</b>: a <b>Live Account</b> and a <b>Demo Account</b>."
      },
      "Trading Platform": {
        "What tools are available for analysis?": "Tradexly provides <b>advanced charting tools</b>, technical indicators, drawing features, and <b>real-time market data</b> for informed decision-making.",
        ...
        "Does Tradexly support cryptocurrencies?": "Yes. You can trade <b>Bitcoin, Ethereum, Litecoin</b>, and other popular cryptocurrencies alongside traditional assets.",
        "Is one-click trading available?": "Yes. Tradexly supports <b>one-click trading</b> for fast order execution without multiple confirmations."
      },
      "Security and Support": {
        "Are my funds safe?": "Yes. All transactions are <b>encrypted</b> using the latest security protocols. Tradexly also keeps client funds in <b>segregated accounts</b>.",
        ...
        "What languages does support cover?": "Tradexly provides multilingual support in <b>English, Spanish, Russian, Hindi, Arabic, and more</b>."
      }
    }
  }
</script>
