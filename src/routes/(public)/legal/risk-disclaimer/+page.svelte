...
<svelte:head>
	<title>Risk Disclaimer - {page.data.cached.site_name}</title>
</svelte:head>

<div class="riskd cont my-10 prose prose-invert sm:prose-lg md:prose-xl lg:prose-2xl">
	...
	<p>
		Trading binary options, digital contracts, forex, commodities, indices, and cryptocurrencies
		involves significant risk of loss and is not appropriate for all investors. The highly leveraged
		nature of these products means that small market movements may have a disproportionately large
		impact on the funds you have deposited or will be required to deposit. This can work against you
		as well as for you. You may sustain a total loss of your initial margin funds and may be
		required to deposit additional funds to maintain your position. If you fail to provide the
		required additional funds within the time required, your position may be liquidated at a loss,
	...
	<p>
		Past performance of financial instruments is not indicative of future results. There is no
		guarantee that you will earn any profit, and you accept the risk that the value of your
		investments may go down as well as up. You acknowledge that losses can exceed your initial
		investment depending on the product traded and market conditions.
	</p>

	<h2>3. Market Volatility and Liquidity Risk</h2>
	...
	<ul>
		<li>Internet connectivity issues or outages;</li>
		<li>Platform or server downtime;</li>
		<li>Delays in price feeds or execution;</li>
		<li>Errors in trade processing or settlement;</li>
	...
	<h2>6. Leverage Risk</h2>

	<p>
		Leverage magnifies both gains and losses. While it allows you to control large positions with
		relatively small capital, it also increases your exposure to potential losses. You may lose more
		than your initial deposit when trading leveraged products. You should never trade with money you
	...
	<h2>9. Tax and Legal Responsibility</h2>
	...
	<h2>10. Self-Exclusion and Responsible Trading</h2>
	...
	<h2>14. Contact for Questions</h2>
	...
	<p>
		<b>WARNING:</b> DO NOT TRADE WITH MONEY YOU CANNOT AFFORD TO LOSE. TRADING IS NOT A “GET RICH QUICK”
		SCHEME. IT REQUIRES SKILL, DISCIPLINE, AND RISK MANAGEMENT. IF YOU DO NOT FULLY UNDERSTAND THE RISKS,
		DO NOT TRADE.
	</p>
</div>
